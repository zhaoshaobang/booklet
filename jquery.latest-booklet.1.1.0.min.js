...
;(function(a) {
	...
	function b(bg, a7) {
		var aH = bg, aI = a7, au = false, aj = false, aS = false, f = false, aR = false, Q = false, o = {
			...
			leftToRight : "LTR",
			rightToLeft : "RTL"
		}, aN = {}, am = {}, e, a1, C, u = [], an = "", az = "/page/", al, ag, ae, ai, at, z, ax, t, V, aG, aF, aD, aB, ay, bd, aP, af, D, k, bb, a2, bc, be, aL, s, aU, B, a0, aZ, aq, aX, aV, x, U, T, P, O, m, l, w, aE, p, a4, Y, S, n, d, aT, aC, aK, c, a8, X, ad, ap, aw, I, K, ar, av, y, aY, E = {
			...
			L = {
				...
				pages : [u[aI.currentIndex].contentNode, u[aI.currentIndex + 1].contentNode]
			};
			if (aI.create) {
			...
			if (aI.tabs && aq.length > 0) {
				...
				aq.css({
					top : "-" + aX.outerHeight() + "px"
				});
				aH.css({
					marginTop : aX.outerHeight()
				});
				if (aI.direction == aO.rightToLeft) {
				...
				if (aI.manual) {
					aB.draggable({
						...
						drag : function(bp, bq) {
							...
							if (aI.shadows) {
								bc.css({
									right : "-" + (aI.shadowTopFwdWidth * bi * 2) + "px"
								});
								if (a.support.opacity) {
									bc.css({
										opacity : bi * 2
						...
						stop : function() {
							...
							if (i > aI.hoverThreshold) {
								...
								bc.animate({
									left : "auto",
									opacity : 0
								}, am.hover.speed, aI.easing).css(aN.sF);
								if (aI.closed && aI.autoCenter) {
									if (aI.currentIndex == 0) {
										aD.animate({
											left : 0
										}, am.hover.speed, aI.easing);
										ay.animate({
											left : 0
										}, am.hover.speed, aI.easing);
										aH.animate({
					...
					aG.draggable({
						...
						drag : function(bp, bq) {
							...
							if (aI.shadows) {
								if (a.support.opacity) {
									...
									be.css({
										left : aI.shadowTopBackWidth * bi * 2
									})
								}
							}
							bh = i * (K - C) + C + bj;
						...
						stop : function() {
							...
							if (i > aI.hoverThreshold) {
								...
								be.animate({
									opacity : 0
								}, am.hover.speed, aI.easing).css(aN.sB);
								s = false;
					...
					if (aI.hoverClick) {
						aH.find(".b-pN, .b-p0").on("click.booklet", M).css({
							cursor : "pointer"
						});
						aH.find(".b-p3, .b-p4").on("click.booklet", aM).css({
							cursor : "pointer"
						})
					}
			...
			if (aI.shadows) {
				if (a.support.opacity) {
					...
					if (i) {
						bh.animate({
							right : aI.shadowTopFwdWidth
						}, h * 2, aI.easeIn)
					} else {
						bh.animate({
							left : aI.shadowTopBackWidth
						}, h * 2, aI.easeIn)
					}
				}
			}
