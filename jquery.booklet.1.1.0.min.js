...
(function(b) {
	...
	function a(ac, ae, G) {
		var myCurNum=0, ao, av, S, A, O, L, I, E, o, ad, ah, C, N, aw = new Array(), K = new Array(), F, ab, Z, Y, W, U, ay, ag, J, s, c, aq, am, ax, az, T, al, ak, R, aj, ai, m, D, B, af, y, e, d, l, X, q, v, r, an, w, k, u, P, n, au, t, g, ap = '<div class="b-page-empty" title="" rel=""></div>', at = '<div class="b-page-blank" title="" rel=""></div>';
		ad = false;
		ah = false;
		C = N = false;
		ao = this;
		...
		if(av.btns2){
			var specal=b(av.btns2);//特殊部分按钮
			
			b(specal[0]).click(function(){
				ao.gotoPage(1+3);
				myCurNum=1;
				y.each(function(index){				
					$(this).val(1+index);
			...
			b(specal[1]).click(function(i){
				i.preventDefault();
				ao.prev();
				
			});
			b(specal[2]).click(function(i){
				i.preventDefault();
				ao.next();
			});
			b(specal[3]).click(function(){
				av.curr=124;
				myCurNum=124;
				ao.gotoPage(124+4);
				y.each(function(index){				
